...
<head>
  ...
  <title>Fallback način rada - LinuxZaSve.com - Recenzije Linux distribucija</title>
...
<style>
#fallback{height: 14px;width: 100%;z-index: 1000;}

.fixed {background-color:#FFFFFF; left top repeat-x;
...
<div id="fallback" class="fixed" style="display: block; top: 0px; ">
        <div class="inner">
      <strong>Fallback način rada</strong> - <a href="index.php">Prebaci se na klasični način rada</a> - Problem ne prestaje? <a href="http://bugs.plsr.tk/thebuggenie/ldr/issues/new">Prijavite ga.</a>
        </div>
...
<body>
  <div class="row">
    <div class="twelve columns">
      <h2><a href="http://linuxzasve.com"><img src="http://www.linuxzasve.com/wp-content/uploads/2012/02/site_logo.png" alt="Linux za Sve" _title="<!-- ovđe ide _title -->" /></a></h2>
<ul class="nav-bar">
...
<li><a href="http://www.linuxzasve.com/linux-za-sve-impressum">O nama</a></li>
  ...
  <div class="row">
    <div class="eight columns">
      <dl class="tabs">
        <dd<?php if($activeMenu=='home')echo ' class="active"';?>><a href="?menu=home">Početna</a></dd>
        <dd<?php if($activeMenu=='compare')echo ' class="active"';?>><a href="?menu=compare">Usporedi</a></dd>
	      </dl>
...
?>             
      ...
      <!--
        ...
        <li id="simple2Tab">Ovdje bi bio sadržaj drugog taba. Naravno, kad bi nešto na njega linkalo :'(</li>
        <li id="simple3Tab">Lorem ipsum dolor sit CUPCAKE!</li>
      </ul>
      -->
